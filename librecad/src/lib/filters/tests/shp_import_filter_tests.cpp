...
// These are the Phase-4a fixtures produced by scripts/make_shp_fixtures.py;
// later phases add their own generated fixtures beside their own cases, and
// the rest of the corpus is fixed reference data.  See the plan's Phase 4a
// for the rationale.
// ---------------------------------------------------------------------------
